        ...
        <div className="hero-content text-center">
            <div className="max-w-md">
                ...
                <div className='flex flex-row'>
                    ...
                    <a target='_blank' href='https://instagram.com/amirhossein.sa12' rel='noreferrer' className="tooltip tooltip-bottom btn btn-primary ml-5 flex" data-tip="Sarhang#9669">
