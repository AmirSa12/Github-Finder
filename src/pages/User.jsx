...
import {FaCodepen, FaStore, FaUserFriends, FaUsers, FaCheckCircle} from 'react-icons/fa'
            ...
            <div className="mb-6">
              <h1 className='text-3xl card-title'>
                ...
                {hireable && (
                  ...
                  Hireable <FaCheckCircle className='ml-2'/>
                </div>
                )}
                {!hireable && (
                  <div className="mx-1 badge badge-info bg-red-500">
                    Hireable <RxCrossCircled className='ml-2'/>
                  </div>
                )}
              </h1>
